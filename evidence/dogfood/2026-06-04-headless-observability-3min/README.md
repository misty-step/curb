...
```sh
CURB_DOGFOOD_SECONDS=180 bash scripts/dogfood-headless-observability.sh evidence/dogfood/2026-06-04-headless-observability-3min
```

Environment:

- Address: `127.0.0.1:63763`
- Config: `config.yaml`
- Mode: visibility
